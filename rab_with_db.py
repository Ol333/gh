...
def kifu_list():
    ...
    temp = ''
    wrong_kifu = [633,641,647,638,1120,1141,1232,4497,4537,4760,4802,6552,6616,7500,7580,9201,9294,9883,9884,
    9886,10058,10059,10061,11173,11468,12535,12956,12961,13204,13422,13705,13712,14268,16835,17515,18186,
    18907,25261,26205,26213,25261,26205,26213,26306,27373,27381,29813,29814,29817,31241,31242,31245,40767,
    40778,42195,42206,43680,45108,55099]
    for a in cur.fetchall():
        if a[1] == temp or a[1] == '' or a[0] in wrong_kifu or a[0] == 641:
            mas.append(a[0])
            kifu_del(a[0])
